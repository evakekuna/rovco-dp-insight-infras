 ...
 * See state.tf for creation of S3 bucket for remote state and remote state locking 
 */
...
# Using the AWS Provider with a shared credentials file for local development 
